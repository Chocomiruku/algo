...
public class GnomeSort {
    ...
    // Сложность O(n^2) - квадратичная. (Не смотря на то, что здесь один цикл и может показаться что
    // сложность O(n), на самом деле сложность алгоритма все еще O(n²), ведь мы поочередно движемся
    // в двух направлениях.)
